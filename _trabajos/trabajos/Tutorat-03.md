...
凸 $n$ 边形内角和等于 $(n-2) \times 180\degree$。如何通过外角和 $360\degree$ 推导内角和公式？
...
直角三角形：
- $30\degree$：三边长比例为 $1 : \sqrt{3} : 2$。
- $45\degree$：三边长比例为 $1 : 1 : \sqrt{2}$（刚好是正方形沿斜对角切一半）。
- $60\degree$：同 $30\degree$，三边长比例为 $1 : \sqrt{3} : 2$。
